...
var Tools = {
	...
	resourcePrefix: (function() {
		var prefix = '';
		if (document.location.protocol === 'file:') prefix = 'file:/';
		return prefix + '//C:/Users/Sean/Documents/GitHub/Pokemon-Showdown-Custom-Client/';
	})(),
	...
	resolveAvatar: function(avatar) {
		...
		if (!isNaN(avatarnum)) {
			...
			return protocol + '://play.pokemonshowdown.com/sprites/trainers/' + avatarnum + '.png';
		}
		if (avatar.charAt(0) === '#') {
			var protocol = (Config.server.port === 443) ? 'https' : 'http';
			return protocol + '://play.pokemonshowdown.com/sprites/trainers/' + toId(avatar.substr(1)) + '.png';
		}
	...
	getTeambuilderSprite: function(pokemon) {
		...
		return 'background-image:url(' + Tools.resourcePrefix + 'sprites/xy'+shiny+'/'+id+'.png)';
	},
